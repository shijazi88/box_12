	...
	<body>
		...
		<div id="navbar" class="navbar navbar-expand-lg justify-content-center align-items-center navbar-fixed">
			<div class="container">
			    ...
			    <button class="button">{{__('Home')}}Join Now</button>					
					...
					<div class="row align-items-center">
						<div class="col-md">
							<div class="content-text">
								<span>{{__('Home')}}Fitness and gym center</span>
								<h1>{{__('Home')}}Make your body healthy and muscular</h1>
								<div class="entry">
									<p>{{__('Home')}}Coming soon...</p>
									<button class="button">{{__('Home')}}Get Started</button>
								</div>
								</ul>
							</div>
						</div>
		...
		<div id="about" class="about">
			<div class="container">
				<h2>{{__('Home')}}We are here to improve health and want to practice fitness properly and correctly</h2>
				<div class="row g-5">
					<div class="col-md-6">
			...
			<div class="container about-container">
				<div class="about-body-container">
					...
					<div class="row">
						<div class="col-md-12">
							<button class="button">{{__('Home')}}Contact us</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="subscriptions" class="pricing subscription">
			<div class="container">
				...
				<div class="row g-5">
					<div class="col-md">
						<div class="content">
							<h2 class="m-0">{{__('Home')}}3 Months</h2>
							<h3 class="custom-color2">$1449</h3>			
							<ul class="mt-20 mb-20">
								<li><i class="la la-check-circle"></i> {{__('Home')}}Expires after 90 days</li>
								<li><i class="la la-check-circle"></i> {{__('Home')}}Expires after 90 days</li>									
								<li><i class="la la-check-circle"></i> {{__('Home')}}Expires after 90 days</li>									
							</ul>							
					...
					<div class="col-md">
						<div class="content">
							...
							<button class="button text-uppercase mb-2 mt-20">{{__('Home')}}Buy now</button>							
						</div>
					</div>
				</div>
			</div>
		...
		<div id="group_exercise" class="group_exercise pt-30">
			<div class="container">
				<h2 class="custom-font45">{{__('Home')}}GROUP EXERCISE<br/> {{__('Home')}}PROGRAMME</h2>  
				<div class="divider"></div>  
				<div class="row pt-90">
		...
		<footer>
			<div class="container">
				<div class="row">
					...
					<div class="col-md col-sm-6">
						<div class="cp">
							<span> {{__('Home')}}Copyright © All Right Reserved </span>
						</div>
					</div>
				</div>
			</div>
