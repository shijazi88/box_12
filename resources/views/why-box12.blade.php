...
<html lang="zxx">
	...
	<body>		
		...
		<!-- What is Box12? -->
		<section id="box12" class="mt-160 pt-60 services section-bg why_box12_section">
      <div class="container">
        <div class="why-content-box mx-auto">
					<div class="section-title text-center">
						<h1 class="custom-font45 custom-color2">WHY BOX12?</h1>          
						<h3 class="text-center box12-para custom-color1">
